    ...
    */
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN BOOK_INFO T0 ON T.'_id'=T0.'_id'");
            builder.append(" LEFT JOIN USER_INFO T1 ON T.'_id'=T1.'_id'");
            builder.append(" LEFT JOIN SALE_INFO T2 ON T.'_id'=T2.'_id'");
            builder.append(" LEFT JOIN ACCESS_INFO T3 ON T.'_id'=T3.'_id'");
            builder.append(' ');
