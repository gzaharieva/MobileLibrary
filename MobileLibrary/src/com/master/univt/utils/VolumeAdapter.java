...
public class VolumeAdapter extends BaseAdapter
{
  ...
  public VolumeAdapter(final Context context, final List<Volume> volume)
  {
    ...
    this.volumes = volume;
    options =
      new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.ic_empty).showImageForEmptyUri(R.drawable.ic_empty)
        .showImageOnFail(R.drawable.ic_empty).cacheInMemory(true).cacheOnDisc(true).considerExifParams(true).build();
  }
